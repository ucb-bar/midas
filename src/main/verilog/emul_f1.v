...
(
  ...
  output reg [`DMA_ADDR_BITS-1:0]  dma_0_ar_addr,
  output reg [`DMA_ID_BITS-1:0]    dma_0_ar_id,
  ...
  output reg [`DMA_ADDR_BITS-1:0] dma_1_ar_addr,
  output reg [`DMA_ID_BITS-1:0]   dma_1_ar_id,
  ...
  output reg [`DMA_ADDR_BITS-1:0] dma_2_ar_addr,
  output reg [`DMA_ID_BITS-1:0]   dma_2_ar_id,
  ...
  output reg [`DMA_ADDR_BITS-1:0] dma_3_ar_addr,
  output reg [`DMA_ID_BITS-1:0]   dma_3_ar_id,
...
`endif
  ...
  reg                        dma_0_ar_valid;
  wire                       dma_0_ar_ready;
  reg  [`DMA_ADDR_BITS-1:0]  dma_0_ar_addr;
  reg  [`DMA_ID_BITS-1:0]    dma_0_ar_id;
  ...
  reg                        dma_1_ar_valid;
  wire                       dma_1_ar_ready;
  reg  [`DMA_ADDR_BITS-1:0]  dma_1_ar_addr;
  reg  [`DMA_ID_BITS-1:0]    dma_1_ar_id;
  ...
  reg                        dma_2_ar_valid;
  wire                       dma_2_ar_ready;
  reg  [`DMA_ADDR_BITS-1:0]  dma_2_ar_addr;
  reg  [`DMA_ID_BITS-1:0]    dma_2_ar_id;
  ...
  reg                        dma_3_ar_valid;
  wire                       dma_3_ar_ready;
  reg  [`DMA_ADDR_BITS-1:0]  dma_3_ar_addr;
  reg  [`DMA_ID_BITS-1:0]    dma_3_ar_id;
